...
for m in $(aerospace list-monitors | awk '{print $1}'); do
  for i in $(aerospace list-workspaces --monitor $m); do
    ...
    space=(
      space="$sid"
      icon="$sid"
      icon.highlight_color=$NORD_BLUE_3
      ...
      label.color=$NORD_WHITE_1
      label.highlight_color=$NORD_BLUE_3
      label.font="sketchybar-app-font:Regular:16.0"
      label.y_offset=-1
      background.color=$NORD_BLACK_1
      background.border_color=$NORD_BLACK_1
